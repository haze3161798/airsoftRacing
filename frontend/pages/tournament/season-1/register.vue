<template>
  <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <h2 class="text-2xl sm:text-3xl font-extrabold text-white mb-8">隊伍報名（職業組）</h2>
    ...
    <div class="relative border-2 border-primary rounded-xl p-6 bg-primary/10 backdrop-blur mb-8">
      ...
      <ol class="text-gray-200 text-sm leading-loose pl-5 space-y-1 list-decimal">
        <li>
          ...
          讓主辦方知道你有意願（適合 1-2 人報名），並註明欲報名「職業組」。
        </li>
        <li>
...
useHead({ title: '隊伍報名（職業組） - Airsoft Racing' })
useSeoMeta({
  description: '極限速度杯 Airsoft Contest 職業組線上報名 — 填寫隊伍資訊與選手資料，立即完成報名。',
  ogTitle: '隊伍報名（職業組） - Airsoft Racing',
  ogDescription: '極限速度杯 Airsoft Contest 職業組線上報名 — 填寫隊伍資訊與選手資料，立即完成報名。',
  ogImage: `${backendBase}/public/banner.png`,
  twitterTitle: '隊伍報名（職業組） - Airsoft Racing',
  twitterDescription: '極限速度杯 Airsoft Contest 職業組線上報名 — 填寫隊伍資訊與選手資料，立即完成報名。',

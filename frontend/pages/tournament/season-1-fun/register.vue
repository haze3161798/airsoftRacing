<template>
  <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <h2 class="text-2xl sm:text-3xl font-extrabold text-white mb-8">隊伍報名（娛樂組）</h2>
    ...
    <div class="relative border-2 border-primary rounded-xl p-6 bg-primary/10 backdrop-blur mb-8">
      ...
      <ol class="text-gray-200 text-sm leading-loose pl-5 space-y-1 list-decimal">
        <li>
          ...
          讓主辦方知道你有意願（適合 1-2 人報名），並註明欲報名「娛樂組」。
        </li>
        <li>
    ...
    <div v-show="currentStep === 2" class="space-y-6">
      ...
      <div class="bg-surface-light border border-surface-border rounded-xl p-6">
        ...
        <div class="space-y-3 text-sm text-gray-300">
          <p>每隊報名費：<span class="text-white font-semibold">2,500 元</span>（原價 3,500 元，已減免 1,000 元）</p>
...
useHead({ title: '隊伍報名（娛樂組） - Airsoft Racing' })
useSeoMeta({
  description: '極限速度杯 Airsoft Contest 娛樂組線上報名 — 填寫隊伍資訊與選手資料，立即完成報名。',
  ogTitle: '隊伍報名（娛樂組） - Airsoft Racing',
  ogDescription: '極限速度杯 Airsoft Contest 娛樂組線上報名 — 填寫隊伍資訊與選手資料，立即完成報名。',
  ogImage: `${backendBase}/public/banner.png`,
  twitterTitle: '隊伍報名（娛樂組） - Airsoft Racing',
  twitterDescription: '極限速度杯 Airsoft Contest 娛樂組線上報名 — 填寫隊伍資訊與選手資料，立即完成報名。',

<template>
  <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <h2 class="text-2xl sm:text-3xl font-extrabold text-white mb-8">報名隊伍一覽（娛樂組）</h2>
...
useHead({ title: '報名隊伍一覽（娛樂組） - Airsoft Racing' })
useSeoMeta({
  description: '查看娛樂組各隊伍報名狀態與成員名單 — Airsoft Racing 氣槍競速賽。',
  ogTitle: '報名隊伍一覽（娛樂組） - Airsoft Racing',
  ogDescription: '查看娛樂組各隊伍報名狀態與成員名單 — Airsoft Racing 氣槍競速賽。',
  ogImage: `${backendBase}/public/banner.png`,
  twitterTitle: '報名隊伍一覽（娛樂組） - Airsoft Racing',
  twitterDescription: '查看娛樂組各隊伍報名狀態與成員名單 — Airsoft Racing 氣槍競速賽。',

      ...
      <div v-if="tournament.description" class="bg-surface-light border border-surface-border rounded-xl p-6 mb-6">
        ...
        <div class="text-gray-300 text-sm leading-relaxed">
          ...
          <p class="text-gray-400 text-xs">
            💰 每隊報名費：<strong class="text-white">2,500 元</strong>（原價 3,500 元，已減免 1,000 元）
          </p>
        </div>
      </div>

      <!-- Solo Registration Info -->
      <div class="relative border-2 border-primary rounded-xl p-6 bg-primary/10 backdrop-blur mb-6">
